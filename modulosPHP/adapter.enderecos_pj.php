...
<?php
  ...
  class enderecos_pj {
    ...
    public function salvar() {
      ...
      try {
        $aValidar = array ( 1 => array('Logradouro' , $_POST['CMPclientes-enderecos-logradouro-PJ'], 'varchar(120)', true),
                            2 => array('Logradouro' , $_POST['CMPclientes-enderecos-logradouro-PJ'], 'varchar(30)', true),
                            3 => array('Numero' , $_POST['CMPclientes-enderecos-numero-PJ'], 'varchar(20)', true),
                            4 => array('Complemento' , $_POST['CMPclientes-enderecos-complemento-PJ'], 'varchar(120)', true),
                            5 => array('Cep' , $_POST['CMPclientes-enderecos-cep-PJ'], 'int', true),
                            6 => array('Bairro' , $_POST['CMPclientes-enderecos-bairro-PJ'], 'varchar(50)', true),
                            7 => array('Uf' , $_POST['CMPclientes-enderecos-uf-PJ'], 'int(8)', true),
                            8 => array('Cid' , $_POST['CMPclientes-enderecos-cid-PJ'], 'int(8)', true),
                            9 => array('Cliente' , $_POST['CMPclientes-enderecos-cliente-PJ'], 'int(8)', true),
                            );
    ...
    public function inicializaAtributos() {
      ...
      $this->NM_LOGRADOURO[0]  = (isset ($_POST['CMPclientes-enderecos-logradouro-PJ'])     ? $_POST['CMPclientes-enderecos-logradouro-PJ']  : '');
      $this->TP_LOGRADOURO[0]  = (isset ($_POST['CMPclientes-enderecos-tp-logradouro-PJ'])  ? $_POST['CMPclientes-enderecos-tp-logradouro-PJ']  : '');
      $this->TX_NUMERO[0]      = (isset ($_POST['CMPclientes-enderecos-numero-PJ'])         ? $_POST['CMPclientes-enderecos-numero-PJ']      : '');
      $this->TX_COMPLEMENTO[0] = (isset ($_POST['CMPclientes-enderecos-complemento-PJ'])    ? $_POST['CMPclientes-enderecos-complemento-PJ'] : '');
      $this->NU_CEP[0]         = (isset ($_POST['CMPclientes-enderecos-cep-PJ'])            ? $_POST['CMPclientes-enderecos-cep-PJ']         : '');
      $this->TX_BAIRRO[0]      = (isset ($_POST['CMPclientes-enderecos-bairro-PJ'])         ? $_POST['CMPclientes-enderecos-bairro-PJ']      : '');
      $this->NM_UF[0]          = (isset ($_POST['CMPclientes-enderecos-uf-PJ'])             ? $_POST['CMPclientes-enderecos-uf-PJ']          : '');
      $this->NM_CID[0]         = (isset ($_POST['CMPclientes-enderecos-cid-PJ'])            ? $_POST['CMPclientes-enderecos-cid-PJ']         : '');
      $this->ID_CLIENTE[0]     = (isset ($_POST['CMPclientes-enderecos-cliente-PJ'])        ? $_POST['CMPclientes-enderecos-cliente-PJ']     : '');
