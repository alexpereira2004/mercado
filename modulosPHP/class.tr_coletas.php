...
<?php
  ...
  class tr_coletas {
    ...
    public function salvar() {
      ...
      try {
        $aValidar = array ( 1 => array('Coleta' , $_POST['CMPcoletas-coleta'], 'date', true),
                            ...
                            5 => array('Carrinho' , $_POST['CMPcoletas-carrinho'], 'int(10)', true),
                            );
    ...
    public function listar($sFiltro = '') {
      ...
      //$this->iLinhasTr_coletas = mysql_num_rows($sResultado);
    ...
    public function inicializaAtributos() {
      ...
      $this->ID_CARRINHO[0]       = (isset ($_POST['CMPcoletas-carrinho'])       ? $_POST['CMPcoletas-carrinho']       : '');
