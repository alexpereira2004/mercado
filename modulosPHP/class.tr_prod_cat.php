...
<?php
  ...
  class tr_prod_cat {
    ...
    public function salvar() {
      ...
      try {
        $aValidar = array ( 1 => array('Cat' , $_POST['CMPprod-cat-cat'], 'int(8)', true),
                            );
    ...
    public function remover($sFiltro = '') {
      $sQuery = "DELETE FROM tr_prod_cat ".$sFiltro;
      $sResultado = mysql_query($sQuery, $this->DB_LINK);
    ...
    public function editar($sFiltro = '') {
      $sQuery = "UPDATE tr_prod_cat
        SET
          id_cat  = '".$this->ID_CAT[0]."', 
    ...
    public function inicializaAtributos() {
      ...
      $this->ID_PROD[0] = (isset ($_POST['CMPprod-cat-prod']) ? $_POST['CMPprod-cat-prod'] : '');
      $this->ID_CAT[0]  = (isset ($_POST['CMPprod-cat-cat'])  ? $_POST['CMPprod-cat-cat']  : '');
