...
<?php
  ...
  class tclv_categorias {
    ...
    public function listar($sFiltro = '') {
      ...
      //$this->iLinhasTclv_categorias = mysql_num_rows($sResultado);
    ...
    public function inserir() {
      $sQuery = "INSERT INTO tclv_categorias(
                             NM_CATEGORIA, 
                             TX_SOUND, 
                             NU_VISUALIZACOES, 
                             CD_STATUS, 
    ...
    public function remover($iId = '') {
      $sQuery = "DELETE FROM tclv_categorias
                       WHERE id = ".$iId;
      $sResultado = mysql_query($sQuery);
