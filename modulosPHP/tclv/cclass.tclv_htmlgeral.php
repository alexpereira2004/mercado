...
<?php
  ...
  class tclv_htmlgeral {
    ...
    public function listar($sFiltro = '') {
      ...
      //$this->iLinhasTclv_htmlgeral = mysql_num_rows($sResultado);
    ...
    public function inserir() {
      $sQuery = "INSERT INTO tclv_htmlgeral(
                             NM_PAGINA, 
                             TX_CONTEUDO, 
                             TX_META_TITU, 
                             DE_META_TAG, 
    ...
    public function remover($iId = '') {
      $sQuery = "DELETE FROM tclv_htmlgeral
                       WHERE id = ".$iId;
      $sResultado = mysql_query($sQuery);
