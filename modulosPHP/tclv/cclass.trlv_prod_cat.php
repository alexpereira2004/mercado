...
<?php
  ...
  class trlv_prod_cat {
    ...
    public function listar($sFiltro = '') {
      ...
      //$this->iLinhasTrlv_prod_cat = mysql_num_rows($sResultado);
    ...
    public function inserir() {
      $sQuery = "INSERT INTO trlv_prod_cat(
                             ID_PROD 
)
      VALUES(
              '".$this->ID_CAT[0]."', 
    ...
    public function remover($iId = '') {
      $sQuery = "DELETE FROM trlv_prod_cat
                       WHERE id_cat = ".$iId;
      $sResultado = mysql_query($sQuery);
