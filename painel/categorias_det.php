...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title><?php echo $CFGaPgAtual[$sPgAtual]['titulo'].' - '.$oCategorias->NM_CATEGORIA[0];?></title>
    <?php
    ...
    <div id="pagina">
      ...
      <div id="corpo">
        ...
        <div id="toolBar">
          ...
          <a href="categorias_edt.php?n=<?php echo $oCategorias->ID[0]; ?>"><img src="../comum/imagens/icones/hammer.png" alt="Editar" /></a>
        </div>

        <table style="margin-top: 10px;" class="tab_lista_registros">
          <tr class="corSim">
            <td class="headerValue w10">Nome:</td>
            <td class="infoValue"><?php echo $oCategorias->NM_CATEGORIA[0]; ?></td>
          </tr>
        </table>
