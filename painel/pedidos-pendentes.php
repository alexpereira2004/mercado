...
//        $aMsg = $oManClientes->aMsg;
  ...
  $sFiltro  = implode("','", $CFGaGrupoPedidosPendentes);
                  ...
                  if ($oPedidos->iLinhas > 0) {
                    for ($i = 1; $i <= $oPedidos->iLinhas; $i++) {
                      ...
                      <tr class="<?php echo ($bLinha) ? 'corSim' : 'corNao'; ?>">
                        ...
                        <td>
                          <a href="clientes_edt.php?n=<?php echo $oPedidos->ID_CLIENTE[$i]; ?>">
                        ...
                        <td><?php echo $oPedidos->CD_PAGSEGURO[$i].'&nbsp;'; ?></td>
